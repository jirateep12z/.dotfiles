...
ShowMenu() {
  ...
  echo " 12. Configure Script"
  echo " 13. Configure Lazygit"
  echo " 14. Configure Python (pip)"
  ...
  echo " 23. Remove Script configuration"
  echo " 24. Remove Lazygit configuration"
  echo " 25. Remove Python configuration"
  echo " 26. Remove Commitizen configuration"
  echo " 27. Remove Windsurf configuration"
  echo " 28. Remove Git configuration"
...
InstallHomebrewPackages() {
  ...
  InstallPackage -package_name "Homebrew taps" -package_list_path "$SCRIPT_DIR/requirement/brew_tap.txt" -install_command "brew tap"
...
Main() {
  ...
  while true; do
    ...
    case $choice in
      ...
      17) SetGitConfig ;;
      18) SetAllApplicationConfigs ;;
      19) RemoveFishConfig ;;
      20) RemoveTmuxConfig ;;
      21) RemoveVimConfig ;;
      22) RemoveNeovimConfig ;;
      23) RemoveScriptConfig ;;
      24) RemoveLazygitConfig ;;
      25) RemovePythonConfig ;;
      26) RemoveCommitizenConfig ;;
      27) RemoveWindsurfConfig ;;
      28) RemoveGitConfig ;;
