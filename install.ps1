...
function ShowMenu {
  ...
  Write-Host " 18. Configure Lazygit"
  Write-Host " 19. Configure Python (pip)"
  Write-Host " 20. Configure Commitizen"
  Write-Host " 21. Configure Windsurf"
  ...
  Write-Host " 29. Remove Lazygit configuration"
  Write-Host " 30. Remove Python configuration"
  Write-Host " 31. Remove Commitizen configuration"
  Write-Host " 32. Remove Windsurf configuration"
  Write-Host " 33. Remove Git configuration"
  Write-Host " 34. Remove all configurations"
  Write-Host ""
  Write-Host "  q. Quit"
  Write-Host ""
}
...
function Main {
  ...
  do {
    ...
    switch ($choice) {
      ...
      "18" { SetLazyGitConfig }
      "19" { SetPythonConfig }
      "20" { SetCommitizenConfig }
      "21" { SetWindsurfConfig }
      "22" { SetGitConfig }
      "23" { SetAllApplicationConfigs }
      "24" { RemovePowerShellConfig }
      "25" { RemoveWindowsTerminalConfig }
      "26" { RemoveVimConfig }
      "27" { RemoveNeovimConfig }
      "28" { RemoveScriptConfig }
      "29" { RemoveLazyGitConfig }
      "30" { RemovePythonConfig }
      "31" { RemoveCommitizenConfig }
      "32" { RemoveWindsurfConfig }
      "33" { RemoveGitConfig }
      "34" { RemoveAllApplicationConfigs }
      "q" { break }
